...
public class BlockAfsu extends Block {
	...
	public BlockAfsu(){
		super(Material.iron);
		setCreativeTab(AkutoEngine.tabAkutoEngine);
		setHardness(1.5F);
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		this.top = iconRegister.registerIcon("autoengine:umfsu_top");
		this.output = iconRegister.registerIcon("autoengine:umfsu_output");
		this.input = iconRegister.registerIcon("autoengine:umfsu_input");
	}
