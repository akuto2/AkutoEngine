...
@Mod (modid = "AkutoEngine", name = "AkutoEngine", version = "1.4.2", dependencies ="required-after:AkutoLib@[1.0.5,);required-after:BuildCraft|Energy;after:IC2;after:ProjectE;", useMetadata = true)
