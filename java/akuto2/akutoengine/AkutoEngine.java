...
import akuto2.akutoengine.event.CommonEventHandler;
import akuto2.akutoengine.event.ToolTipEvent;
...
import akuto2.akutoengine.pattern.FillerFillBox;
import akuto2.akutoengine.pattern.FillerFillWall;
import akuto2.akutoengine.pattern.FillerFlattener;
import akuto2.akutoengine.pattern.FillerFlooring;
import akuto2.akutoengine.pattern.FillerHoe;
import akuto2.akutoengine.pattern.FillerHoleFill;
import akuto2.akutoengine.pattern.FillerPatternCore;
import akuto2.akutoengine.pattern.FillerPatternRecipe;
import akuto2.akutoengine.pattern.FillerQuarry;
import akuto2.akutoengine.pattern.FillerRemover;
import akuto2.akutoengine.pattern.FillerRemover2;
import akuto2.akutoengine.pattern.FillerTorch;
import akuto2.akutoengine.pattern.FillerTower;
...
@Mod (modid = "AkutoEngine", name = "AkutoEngine", version = "1.4.3", dependencies ="required-after:AkutoLib@[1.0.5,);required-after:BuildCraft|Energy;after:IC2;after:ProjectE;", useMetadata = true)
public class AkutoEngine {
	...
	public static Block exprosionProInfinityChest;
