...
public class ItemBlockHumfsu extends ItemBlock{
	public ItemBlockHumfsu(Block block){
		super(block);
	}
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List tooltipList, boolean par4){
	    ...
	    String capacity = StatCollector.translateToLocal("ic2.item.tooltip.Capacity") + " " + "800m EU";
