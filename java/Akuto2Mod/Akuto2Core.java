...
@Mod (modid = "AkutoEngine", name = "AkutoEngine", version = "1.3.10", dependencies ="required-after:AkutoLib;required-after:BuildCraft|Energy;after:IC2;after:ProjectE;", useMetadata = true)
